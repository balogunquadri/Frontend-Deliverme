    ...
    <div className="mx-auto max-w-6xl px-6 py-6 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="rounded-lg bg-blue-50 p-6 border border-blue-200">
          <p className="text-sm text-gray-600">Pending Restaurants</p>
          <p className="text-3xl font-bold text-blue-600">{restaurant.length}</p>
        </div>
        <div className="rounded-lg bg-green-50 p-6 border border-green-200">
          <p className="text-sm text-gray-600">Pending Riders</p>
          <p className="text-3xl font-bold text-green-600">{riders.length}</p>
        </div>
      </div>
      ...
      <div className="flex gap-4">
        <button
          ...
          className={`px-4 py-2 rounded ${
            tab === "restaurant" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 rounded ${
            tab === "rider" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        >
