  ...
  return (
    <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
        ...
        <div className="flex flex-wrap gap-2 pt-2">
          {actions.map((status) => (
            <button
              ...
              className="rounded-lg bg-[#373ae2] px-3 py-1 text-xs text-white hover:bg-[#d32f3a] disabled:opacity-50"
            >
      ...
      {order.status === "ready_for_rider" && retryVisible && (
        <div className="pt-2">
          <button
            className="w-full rounded-lg border border-[#373ae2] py-2 text-xs font-semibold text-[#373ae2] hover:bg-blue-50 disabled:opacity-50"
